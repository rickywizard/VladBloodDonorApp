        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (bloodGroup.equals("Select blood type")) {
                    Toast.makeText(DonorRegisterActivity.this, "Select Blood Type", Toast.LENGTH_SHORT).show();
                }
                            ...
                            if (!task.isSuccessful()) {
                                ...
                                userDatabaseRef.updateChildren(userInfo).addOnCompleteListener(new OnCompleteListener() {
                                    ...
                                    public void onComplete(@NonNull Task task) {
                                        if (task.isSuccessful()) {
                                            Toast.makeText(DonorRegisterActivity.this, "Data set Successful", Toast.LENGTH_SHORT).show();
                                        }
                                        else {
                                ...
                                if (resultUri != null) {
                                    ...
                                    uploadTask.addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(DonorRegisterActivity.this, "Image Upload Failed", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                                ...
                                                result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                    ...
                                                    public void onSuccess(Uri uri) {
                                                        ...
                                                        userDatabaseRef.updateChildren(newImageMap).addOnCompleteListener(new OnCompleteListener() {
                                                            ...
                                                            public void onComplete(@NonNull Task task) {
                                                                if (task.isSuccessful()) {
                                                                    Toast.makeText(DonorRegisterActivity.this, "Image url added to database succesfully", Toast.LENGTH_SHORT).show();
                                                                }
                                                                else {
                                                                    Toast.makeText(DonorRegisterActivity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                                                }
